...
public class Student : Entity
{
    ...
    public override string ToString()
    {
        return $"student {Id} {Name} {string.Join(" ", Courses)}";
    }
}
...
public class Teacher : Entity
{
    ...
    public List<string> Courses { get; set; } = new List<string>(); // Now storing course names
    ...
    public override string ToString()
    {
        return $"teacher {Id} {Experience} {Name} {string.Join(" ", Courses)}";
    }
}
...
public class Course : Entity
{
    ...
    public override string ToString()
    {
        return $"course {Id} {Name} {string.Join(" ", Students)}";
    }
}
...
class Program
{
    static void Main(string[] args)
    {
        ...
        var teacher1 = new Teacher(1, "John Doe", 5);
        db.Teachers[teacher1.Id] = teacher1;

        var student1 = new Student(1, "Ana");
        var student2 = new Student(2, "Bob");
        db.Students[student1.Id] = student1;
        db.Students[student2.Id] = student2;

        var course1 = new Course(1, "Python Programming"); // Removed TeacherId
